...
from typing import Annotated, List  # for list of allergies
from typing import Dict  # for contact details
from typing import Optional  # for optional fields
from pydantic import EmailStr,AnyUrl,Field

class Patient(BaseModel):
    name: Annotated[str, Field(max_length=25,title="Patient Name", description="Name of the patient", json_schema_extra=["John Doe","sourabh"])]
    email: EmailStr
    linkedIn_url : AnyUrl
    age: int
    weight:  Annotated[float,Field(gt=0,strict=True)]
    married: Annotated[bool,Field(default=None,description="Marital status of the patient")]
    allergies: Annotated[Optional[List[str]],Field(default=None ,max_length=25)] # allergies is a list of strings
    contact: Dict
